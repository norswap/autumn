...
class Lookahead : EmptyGrammarFixture()
{
    ...
    @Test fun ahead() {
        top { seq { ahead { string("a") } && string("a") } }
        success("a")
        failure_at("ab", 1, PartialMatch)
        failure_expect("", 0, "a")

        top { seq { ahead { string("ab") } && string("a") && string("b") && string("c") } }
        success("abc")
    ...
    @Test fun lookahead_transact() {
        ...
        top { choice { not { stack.push(42); string("a") } || string("a") } }
        success("a")
