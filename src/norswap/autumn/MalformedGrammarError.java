...
/**
 * Thrown by {@link Autumn}'s {@code parse} methods when the {@link ParseOptions#well_formed_check}
 * or {@link ParseOptions#well_formed_checker} options is specified, and the supplied parser
 * fails the {@link WellFormednessChecker} check.
 */
